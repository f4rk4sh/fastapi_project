...
from app.api.routes.account_type.endpoints import router as account_type_router
...
from app.api.routes.employer_payment_method.endpoints import router as employer_payment_method_router
...
from app.api.routes.payment_status_type.endpoints import router as payment_status_type_router
...
router = APIRouter()
router.include_router(account_type_router)
router.include_router(auth_router)
router.include_router(bank_router)
router.include_router(employee_router)
router.include_router(employer_router)
router.include_router(employer_payment_method_router)
router.include_router(health_router)
router.include_router(payment_status_type_router)
