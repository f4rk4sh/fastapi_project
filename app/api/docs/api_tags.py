...
from app.db.models import Base, Employee, Employer, EmployerType, Role, StatusType, PaymentStatusType
    ...
    return [
        ...
        for tag in [
            get_crud_tag(model) for model in [
                Employee, Employer, EmployerType, PaymentStatusType, Role, StatusType
            ]
        ]
    ]
